...
2. Fixes have been made to the configuration window.
3. Fixes have been made to the console application.
4. Windows Terminal has been updated.
5. Translations have been improved.
6. Resources have been updated to version v1.1.0.
- The issue with shadows has been fixed. Character outlines should look better now.
- Added new presets made by RoStar_06#7390.
- Added new shaders.
- Updated shaders.
7. Fixed buttons "Mute music on start" and "Disable Discord RPC".
8. Other fixes.
...
1. The window with random images and videos has been improved.
1. The quality has been improved.
1. Numerous improvements have been made regarding the program's functionality and quality.

### ✔ FPS Unlock
1. The issue with unlocking FPS has been resolved. From now on, the frame rates are unlocked every time.
1. The appearance of the program has been improved.
1. The code quality has been enhanced.

# 📥 » v7.3.3-alpha.0
> **Date:** 25.05.2023 [DD.MM.YYYY]
1. Fixes in all apps.
2. Quality fixes.
3. Fixed error with the WindowsAPICodePack (TashbarManager).
