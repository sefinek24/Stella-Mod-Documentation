...
###### Title: Changelog for v7.x.x - Stella Mod Documentation
...
## {#ver-794_project} Project
1. Updated date `2023` -> `2024`.

## {#ver-794_sml-gsm} Stella Mod Launcher & Genshin Stella Mod
...
## {#ver-794_keyUpdatedToConsider} Key Updates to Consider:
...
## {#ver-794_importantBIOSSettingsToVerify} Important BIOS Settings to Verify:
...
## {#ver-790_vsc} Visual Studio Projects
1. Updated all Nuget packages.
2. Updated Visual Studio to 17.8.2.

## {#ver-790_sml} Stella Mod Launcher
...
## {#ver-790_cfg-window} Configuration window - v1.0.6.0
1. Slightly darkened the background.
2. Visual improvements.
3. Improved code quality.

## {#ver-790_resources} Resources - v1.3.0
...
## {#ver-790_smplus} For Stella Mod Plus+ Subscribers
...
## {#ver-790_innosetup} InnoSetup Installer
