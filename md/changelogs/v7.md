...
# 📥 Version v7.9.0 {#changelog-790}
## {#changelog-790_important} Important (for Stella Mod Launcher)
...
## {#changelog-790_vsc} Visual Studio Projects
1. Updated all Nuget packages.
2. Updated Visual Studio to 17.8.2.

## {#changelog-790_sml} Stella Mod Launcher
...
## {#changelog-790_cfg-window} Configuration window - v1.0.6.0
1. Slightly darkened the background.
2. Visual improvements.
3. Improved code quality.

## {#changelog-790_resources} Resources - v1.3.0
...
## {#changelog-790_smplus} For Stella Mod Plus+ Subscribers
...
## {#changelog-790_innosetup} InnoSetup Installer
